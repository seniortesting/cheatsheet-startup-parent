...
(
    ...
    remark      VARCHAR(500)        NOT NULL DEFAULT '' COMMENT '对应记录备注',
    ...
    create_by   VARCHAR(64)         NOT NULL DEFAULT '' COMMENT '对应记录的创建者',
    update_time DATETIME            NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '对应记录的最后修改时间',
    update_by   VARCHAR(64)         NOT NULL DEFAULT '' COMMENT '对应记录的最后修改者',
    PRIMARY KEY (id),
